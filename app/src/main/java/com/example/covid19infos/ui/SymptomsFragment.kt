...
class SymptomsFragment: Fragment(R.layout.fragment_symptoms) {
    ...
    val symptom1 = Symptoms(
        R.drawable.ic_chest_pain_symptoms,
        "Chest Pain"
    )
    val symptom2 = Symptoms(
        R.drawable.ic_sore_throat_symptoms,
        "Sore Throat"
    )
    val symptom3 = Symptoms(
        R.drawable.ic_muscle_pain_symptoms,
        "Muscle Pain"
    )
    val symptom4 = Symptoms(
        R.drawable.ic_fever_symptoms,
        "Fever"
    )
    val symptom5 = Symptoms(
        R.drawable.ic_headache_symptoms,
        "Headache"
    )
    val symptom6 = Symptoms(
        R.drawable.ic_sneeze_symptoms,
        "Sneeze"
    )
